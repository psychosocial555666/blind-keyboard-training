...
const WelcomeScreen = () => {
  return (
    <div className="welcome-screen container">
      ...
      Постарайся не смотреть на клавиатуру при печати. И не забудь <strong>проверить раскладку клавиатуры</strong>. Если готов, нажимай кнопку &apos;Начать&apos;.
      </p>
      <img src="./img/keyboard.png" width="600" height="260" alt="Правильное расположение пальцев" className="welcome-screen__prompt"/>
      <button type="button" className="welcome-screen__start btn btn-outline-light">Начать</button>
    </div>
  );
};
